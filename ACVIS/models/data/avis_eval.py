...
def eval_track(out_dir, gt_file):
    ...
    if os.path.isabs(gt_file):
        default_dataset_config['GT_FOLDER'] = os.path.dirname(gt_file)
        default_dataset_config['GT_File'] = os.path.basename(gt_file)
    else:
        default_dataset_config['GT_FOLDER'] = os.getenv(
            "DETECTRON2_DATASETS", default_dataset_config['GT_FOLDER']
        )
