...
def add_avism_config(cfg):
    ...
    # AURORA is an opt-in, training-free inference method. It reuses the frozen
    # detector and tracker predictions without adding checkpoint parameters.
    cfg.MODEL.AVISM.AURORA_ENABLED = False
